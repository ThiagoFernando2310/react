...
export function Requisicao() {
    ...
    if (isError) return <p>deu erro rapa</p>
        ...
        <>
            <div className="flex justify-center items-center min-h-screen m-8 gap-4 flex-col">
                <div className="flex justify-center items-center mt-4">
                    <button className="bg-cyan-600 rounded-full text-center p-2 " onClick={() => navigate("/")}>escolher outro usuário</button>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
                    ...
                    <div>
                        ...
                        <a className=" flex bg-cyan-600 rounded-full  p-2 mt-1 justify-center" href={user.html_url} target="_blank">Ver perfil completo</a>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-6xl">
                    <ul className="list-disc ml-6 mt-2 space-y-2 list-none">
                        {!repos || repos.length === 0 ? (
                            <p>Não há Repositórios publicos</p>
                        ) : (
